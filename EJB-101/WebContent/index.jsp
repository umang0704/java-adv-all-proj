...
<body>
	<div class="jumbotron jumbotron-fluid" style='text-align:center;size:25%;background: #b3d1ff !important;padding:10px;margin: 10px 10% 10px 10%;border-radius: 15px'>
	  <div class="container">
	    <h1 class="display-4">Calculator</h1>
	    <p class="lead">Enter n-1 and n-2 for operations.</p>
	  </div>
	</div>
	<form action='result.jsp' method='POSt' style=' background: #ffcc99;padding:50px;margin: 10px 10% 10px 10%;border-radius: 15px'>
