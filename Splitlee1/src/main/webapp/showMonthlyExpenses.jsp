<%@page import="dynamicUtil.DateTime,java.util.*,dao.UserUtil" %>
<%
...
HashMap<Character,Integer> d = DateTime.getIntDate(date);
if(name!=null){
%>
...
<body>
	...
	<div style='padding:5px;border:5px;background-image: linear-gradient(to bottom right,#ffffff,#cbf7cc)' id='expenses'>
		...
		<table class="table table-striped">
		  ...
		  <tbody>
		<%
		ArrayList<ArrayList<Object>> details = UserUtil.getMonthlyExpense(email, d.get('m'), d.get('y'));
		int i = 0;
...
<!-- 		      		<input type="hidden" name='goto' value='showMonthlyExpenses.jsp'> -->
