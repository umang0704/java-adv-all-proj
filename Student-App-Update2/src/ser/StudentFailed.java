...
public class StudentFailed extends HttpServlet {
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"ISO-8859-1\">\r\n"
				...
				+ "	<a href=\"index.html\">Back</a>\r\n" + "	<hr>" + "<h1> Failed students.<h1><hr>");
		try {
			// getting servlet context
			ServletContext c = getServletContext();
			Connection conn = (Connection) c.getAttribute("conn");
			Statement st = conn.createStatement();
			ResultSet rs = st.executeQuery("SELECT * FROM `student_app`.`student` where status='fail';");
